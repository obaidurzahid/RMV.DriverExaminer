...
namespace RMV.DriverExaminer.WebApi.Middleware
{
    public sealed class GlobalExceptionHandler : IExceptionHandler
    {
        private readonly ICustomLogger<GlobalExceptionHandler> _logger;

        public GlobalExceptionHandler(ICustomLogger<GlobalExceptionHandler> logger)
        {
            _logger = logger;
        }
        ...
        CancellationToken cancellationToken)
        {
            ...
            _logger.Error($"GlobalExceptionFilter: Error in {httpContext.Request.Method} {httpContext.Request.Path}. " +
